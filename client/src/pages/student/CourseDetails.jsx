...
const CourseDetails = () => {
  ...
  const {allCourses,calculateRating,currency,calculateChapterTime, calculateCourseDuration ,calculateNoOfLectures} = useContext(AppContext);

  //console.log(calculateCourseDuration(courseData));
  ...
  return courseData ? (
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        <p className="pt-4 text-justify md:text-base text-sm"
        ...
        <p className="text-sm">Course by <span className="text-blue-600 underline">Harmony</span></p> 
      ...
      <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden
       bg-white min-w-[300px] sm:min-w-[420px]">
        ...
        <div className="p-5">
          <div className="flex items-center gap-2">
            <img className="w-3.5" src={assets.time_left_clock_icon} alt="time eft clock icon"/>          
          ...
          <div className="flex gap-3 items-center pt-2">
            ...
            <p className="md:text-lg text-gray-500">{courseData.discount}% of</p>
          </div>
          ...
          <div className="pt-6">
            ...
            <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
              ...
              <li>Finally certificate of completion</li>
            </ul>
          </div>
        </div>
      </div>
